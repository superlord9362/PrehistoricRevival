...
public class CultivatorResult {
	...
	private CultivatorResult(NavigableMap<Float, ItemStack> results, float total) {
	...
	public ItemStack next() {
		return this.next(CultivatorResult.random);
	}
	
	public static CultivatorResult read(PacketBuffer buffer) {
	...
	public static class Builder {
		...
		public CultivatorResult build() {
			return new CultivatorResult(this.results, this.total);
		}
	}
