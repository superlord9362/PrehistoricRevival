...
public class CultivatorBlock extends Block {

	public static final DirectionProperty FACING = HorizontalBlock.HORIZONTAL_FACING;
	public static final BooleanProperty ACTIVE = BooleanProperty.create("active");

	public CultivatorBlock(Properties builder) {
		super(builder);
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return PRTileEntities.CULTIVATOR.get().create();
	}
	...
	public void onBlockPlacedBy(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack stack) {
		...
		if (stack.hasDisplayName()) {
			...
			if (tile instanceof CultivatorTileEntity) {
				((CultivatorTileEntity)tile).setCustomName(stack.getDisplayName());
			}
		}
	}
