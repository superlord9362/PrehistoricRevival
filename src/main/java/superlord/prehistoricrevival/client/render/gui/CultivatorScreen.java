...
{
	private static final ResourceLocation TEXTURE = new ResourceLocation(PrehistoricRevival.MOD_ID, "textures/gui/containers/cultivator.png");

	public CultivatorScreen(CultivatorContainer screenContainer, PlayerInventory inv, ITextComponent titleIn)
	{
